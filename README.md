## Tienda Odora:
Este es un proyecto de ecommerce básico realizado para el curso de React JS. La aplicacion permite ver una lista de productos de perfumes y realizar compras en linea. Los productos y las órdenes de compra se almacenan en Firebase.
